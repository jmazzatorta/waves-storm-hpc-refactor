...
% \begin{figure*}[t]
% \centering
% \includegraphics[width=\textwidth]{figures/domain_decomposition.pdf}
% \caption{Hybrid domain decomposition.}\label{fig:domain-decomp}
% \end{figure*}
...
% \begin{figure}[t]
% \centering
% \includegraphics[width=\columnwidth]{figures/strong_scaling.pdf}
% \caption{MPI+OpenMP strong scaling: speedup vs.\ number of cores.}\label{fig:strong}
% \end{figure}
...
\midrule
\multirow{3}{*}{30\,K}
  & storm\_kernel      & 19.891\,ms & 99.1\% \\
  & reduce\_max        & 0.018\,ms  & 0.1\% \\
  & stencil            & 0.012\,ms  & 0.1\% \\
\midrule
\rowcolor{TableRowAlt}
\multirow{3}{*}{1\,M}
  & storm\_kernel      & 69.317\,ms & 99.7\% \\
\rowcolor{TableRowAlt}
  & reduce\_max        & 0.129\,ms  & 0.2\% \\
\rowcolor{TableRowAlt}
  & stencil            & 0.069\,ms  & 0.1\% \\
\bottomrule
\end{tabular}
\end{table}
